    ...
    render() {
        ...
        return (
            <div className="pagination-table">
                ...
                <div className={styles.pagination_warp}>
                    <Pagination pageSize={20} onCurrentChange={this.props.onCurrentChange} layout="prev, pager, next" total={this.props.queryAmount}/>
                </div>
            </div>
        )
    }
